...
$('#submit').click(function(e){
	...
	is_active_inv_item = $('#is_active_inv_item').val();
	item_image_url = $('#item_image_url').prop('files')[0];
	is_feature = $("#is_feature").is(':checked')? 1 : 0;
	
	
		
	if(typeof item_name !== 'undefined' && item_name !== '' && typeof item_category !== 'undefined' && item_category !== ''
	&& typeof item_image_url !== 'undefined' && item_image_url !== '')
	{
