		...
		<div class="card card-primary">
			<div class="card-header">
				...
				<div style="text-align: right;">
					<a type="button" href="<?php echo base_url() ?>SystemNotification/create" class="btn text-dark btn-default btn-sm">
						<i class="nav-icon far fa-plus-square"></i> Add Notification
					</a>
				</div>
			</div>
