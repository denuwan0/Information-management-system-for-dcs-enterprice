...
$.ajax({
	...
	success: function(data, result){
		var item_category_drp = '<option value="">Select Item Category</option>';
...
$('#submit').click(function(e){
	...
	if(typeof item_category_id !== 'undefined' && item_category_id !== '' && typeof sub_cat_name !== 'undefined' && sub_cat_name !== ''
	&& typeof sub_cat_description !== 'undefined' && sub_cat_description !== '' )
	{
		...
		$.ajax({
			...
			contentType: false,
			data: formData,	
			url: API+"ItemSubCategory/insert/",
			success: function(data, result){
				console.log(data);	
